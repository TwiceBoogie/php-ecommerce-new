...
<div id="main-wrapper" class="container mt-5">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
                ...
                <div class="row g-0">
                    ...
                    <div class=" p-5">
                        <div class="mb-4">
                            ...
                            <p class="text-muted">Create your account to access services.</p>
                        </div>

                        <form id="register-form">
                            <div class="mb-3 form-group">
                                <label for="register-name" class="form-label">Full name</label>
                                <input type="text" class="form-control form-control-lg" id="register-name" name="name"
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="password" class="form-control form-control-lg"
                                    id="register-confirm-password" name="confirmPassword" placeholder="Enter password">
                            </div>
                            <button type="submit" id="register-btn" name="register_btn"
            ...
            <p class="text-center mt-4">Already have an account? <a href="/login" class="text-primary fw-bold">Login</a>
            </p>
        </div>
    </div>
</div>
